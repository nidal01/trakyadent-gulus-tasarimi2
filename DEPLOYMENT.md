...
Projede `app/api/contact/route.ts` endpoint'i SMTP ayarlarını environment variable üzerinden okuyor. Production'da bu değerleri hosting panelinden güvenli şekilde yönetmelisin.
